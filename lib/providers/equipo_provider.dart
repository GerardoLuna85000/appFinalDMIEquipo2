...
class EquipoProvider with ChangeNotifier{
 ...
 String? _equipoId;
  ...
  saveEquipo(){
    if (_equipoId == null) {
      var newEquipo 
      = Equipo(equipoId: uuid.v4(), marca: _marca, modelo: _modelo, nserie: _nserie, alias: _alias, asignado: _asignado);
      firestoreService.saveEquipo(newEquipo);
    }else{
      var existingEquipo 
      = Equipo(equipoId: _equipoId, marca: _marca, modelo: _modelo, nserie: _nserie, alias: _alias, asignado: _asignado);
